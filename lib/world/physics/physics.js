...
teien.Physics.prototype.addPhysicsObject = function(obj, actorInfo) {
//    obj.physicsObject = teien.Physics.createObject(obj);

    if (actorInfo.usePhysics && obj.rigidBody !== null) {
	if (actorInfo.collisionFilter) {
            this.addRigidBody(obj.rigidBody, actorInfo.collisionFilter);
	}
	else {
	    this.addRigidBody(obj.rigidBody);
	}
    }
};        

...
teien.UserInterface.createObject = function(name, actorInfo, userInterface) {
...
teien.UserInterface.prototype.createViewObject = function(name, actorInfo, transform) {
    if (this.objects[name] !== undefined) {
	console.log("UserInterface: There is a object with the same name: " + name);
	return this.objects[name];
    }
    else {
	var obj = teien.UserInterface.createObject(name, actorInfo, this);
...
teien.UserInterface.prototype.update = function(models) {
	...
	if (this.objects[key] === undefined) {
	    this.objects[key] = this.createViewObject(key, model.actorInfo, model.transform);
	}
	else {
